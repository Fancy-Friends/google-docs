...
| Registry | Package |
|---|---|
| npm | `@particle-academy/google-docs-js` (+ `@particle-academy/google-docs-ui`, resolved transitively) |
...
npm install @particle-academy/google-docs-js @particle-academy/fancy-flow
