 ...
 */
/**
 * Every Google Docs node executor — the PHP twin of
 * `GOOGLE_DOCS_RUNNABLE_KINDS` in @particle-academy/google-docs-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `GoogleDocsFlow::register($kinds, $executors)` — one call, no directory
 * scan.
